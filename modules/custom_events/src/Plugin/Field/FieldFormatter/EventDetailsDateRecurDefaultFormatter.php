 ...
 *
 * @FieldFormatter(
 *   id = "event_details_date_recur_default_formatter",
 *   label = @Translation("Event details date recur default formatter"),
 *   field_types = {
 *     "date_recur"
 *   }
 * )
 */
class EventDetailsDateRecurDefaultFormatter extends DateRangeDefaultFormatter {
